    ...
    try {
      ...
      reader.onload = (e) => {
        try {
          ...
          if (!data.length) {
            toast.error("فایل پشتیبان خالی است!", {
              style: {
          ...
          toast.success("فایل پشتیبان با موفقیت آپلود شد", {
            style: {
          ...
          toast.error("خطا در خواندن فایل پشتیبان!", {
            style: {
              backgroundColor: "#e7000b",
              boxShadow: "0px 3px 15px 0px rgba(231, 0, 11, 0.25)",
            },
      ...
      reader.onerror = () => {
        toast.error("خطا در آپلود فایل پشتیبان!", {
          style: {
            backgroundColor: "#e7000b",
            boxShadow: "0px 3px 15px 0px rgba(231, 0, 11, 0.25)",
          },
